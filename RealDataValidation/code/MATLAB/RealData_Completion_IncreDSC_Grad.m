    ...
    if ICPD_flag
        ...
        for rr =1:Rt(tt)
            ...
            for iter = 1:iter_inner
               [Ait{rr},Bit{rr},Rit{rr},Sit{rr},Pjt{rr},Qjt{rr},cals{rr}] = UpdateAll_Grad_Re(Ait{rr},Bit{rr},c_incre{rr},Rit{rr},Sit{rr},Pjt{rr},Qjt{rr},Yt_rr,Wtt,lambda);
            end
            cacheA{rr,tt} = Ait{rr};
            cacheB{rr,tt} = Bit{rr};
...
%% save NMSEmat
save(['..\..\result\NMSE_IncreDSC_Grad_rho',num2str(rho),'.mat'],"NMSEcomp");
